  ...
  try
  {
    ...
    for($i=0;$i<count($stu1);$i++)
    {
      // check if already exist in batch
        ...
        $stmt->bind_param("ii", $batch,$stu1[$i]);
        $Resp=$stmt->execute();
    }
...
<h4 class="fw-bold py-3 mb-4">Batch Assign</h4>
...
<script type="text/javascript">
  ...
  {
    /*var list1=$('#stu_list1 :selected').val();
    console.log("selected="+list1);*/

    $("#stu_list1 :selected").each(function() {
      console.log(this.value);
      $('#stu_list2').append('<option value="'+this.value+'" selected class="list-group-item drag-item cursor-move d-flex justify-content-between align-items-center">'+this.text+'</option>');
      $(this).remove();
    });
  ...
  {
    /*var list2=$('#stu_list2 :selected').val();
    console.log("selected="+list2);*/

    $("#stu_list2 :selected").each(function() {
      console.log(this.value);
      $('#stu_list1').append('<option value="'+this.value+'" selected class="list-group-item drag-item cursor-move d-flex justify-content-between align-items-center">'+this.text+'</option>');
      $(this).remove();
    });
  }
</script>
