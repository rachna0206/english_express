                        ...
                        <div class="mb-3">
                          ...
                          <label class="form-label" for="basic-default-fullname">Notifications</label><br>
                           ...
                           <input type="checkbox" name="n24" id="n24" value="none" <?php if(($per[149])=="y"){?> checked="checked" <?php } ?>/> None
												...
												<hr>
												<div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">Task Assign</label><br>
                           <input type="checkbox" name="r25" id="r25" value="read" <?php if(($per[150])=="y"){?> checked="checked" <?php } ?>/> Read
                           <input type="checkbox" name="w25" id="w25" value="write" <?php if(($per[151])=="y"){?> checked="checked" <?php } ?>/> Write
                           <input type="checkbox" name="d25" id="d25" value="delete" <?php if(($per[152])=="y"){?> checked="checked" <?php } ?>/>	Delete
                           <input type="checkbox" name="u25" id="u25" value="update" <?php if(($per[153])=="y"){?> checked="checked" <?php } ?>/>	Update
                           <input type="checkbox" name="a25" id="a25" value="all" <?php if(($per[154])=="y"){?> checked="checked" <?php } ?>/> All
                           <input type="checkbox" name="n25" id="n25" value="none" <?php if(($per[155])=="y"){?> checked="checked" <?php } ?>/> None
												</div>
												<hr>
												<div class="mb-3">
...
// for Student Report  
  $('#a20').click(function(){
	 if($(this).is(':checked')){
		 $('#r20,#w20,#d20,#u20').prop('checked',true);
		 $('#n20').prop('checked',false);
	 }
	 else{ $('#r20,#w20,#d20,#u20').prop('checked',false); }
  });
  $('#r20,#w20,#d20,#u20').click(function(){
	 if($(this).is(':checked')){ $('#n20').prop('checked',false);}
	 else{ $('#a20,#n20').prop('checked',false); }
  });
  $('#n20').click(function(){
	 if($(this).is(':checked')){ $('#r20,#w20,#d20,#u20,#a20').prop('checked',false); }
	 else{ }
  });
// for Faculty Report  
  $('#a21').click(function(){
	 if($(this).is(':checked')){
		 $('#r21,#w21,#d21,#u21').prop('checked',true);
		 $('#n21').prop('checked',false);
	 }
	 else{ $('#r21,#w21,#d21,#u21').prop('checked',false); }
  });
  $('#r21,#w21,#d21,#u21').click(function(){
	 if($(this).is(':checked')){ $('#n21').prop('checked',false);}
	 else{ $('#a21,#n21').prop('checked',false); }
  });
  $('#n21').click(function(){
	 if($(this).is(':checked')){ $('#r21,#w21,#d21,#u21,#a21').prop('checked',false); }
	 else{ }
  });
// for Attendance Report  
  $('#a22').click(function(){
	 if($(this).is(':checked')){
		 $('#r22,#w22,#d22,#u22').prop('checked',true);
		 $('#n22').prop('checked',false);
	 }
	 else{ $('#r22,#w22,#d22,#u22').prop('checked',false); }
  });
  $('#r22,#w22,#d22,#u22').click(function(){
	 if($(this).is(':checked')){ $('#n22').prop('checked',false);}
	 else{ $('#a22,#n22').prop('checked',false); }
  });
  $('#n22').click(function(){
	 if($(this).is(':checked')){ $('#r22,#w22,#d22,#u22,#a22').prop('checked',false); }
	 else{ }
  });
// for Dashboard  
  $('#a23').click(function(){
	 if($(this).is(':checked')){
		 $('#r23,#w23,#d23,#u23').prop('checked',true);
		 $('#n23').prop('checked',false);
	 }
	 else{ $('#r23,#w23,#d23,#u23').prop('checked',false); }
  });
  $('#r23,#w23,#d23,#u23').click(function(){
	 if($(this).is(':checked')){ $('#n23').prop('checked',false);}
	 else{ $('#a23,#n23').prop('checked',false); }
  });
  $('#n23').click(function(){
	 if($(this).is(':checked')){ $('#r23,#w23,#d23,#u23,#a23').prop('checked',false); }
	 else{ }
  });
// for Notifications  
  $('#a24').click(function(){
	 if($(this).is(':checked')){
		 $('#r24,#w24,#d24,#u24').prop('checked',true);
		 $('#n24').prop('checked',false);
	 }
	 else{ $('#r24,#w24,#d24,#u24').prop('checked',false); }
  });
  $('#r24,#w24,#d24,#u24').click(function(){
	 if($(this).is(':checked')){ $('#n24').prop('checked',false);}
	 else{ $('#a24,#n24').prop('checked',false); }
  });
  $('#n24').click(function(){
	 if($(this).is(':checked')){ $('#r24,#w24,#d24,#u24,#a24').prop('checked',false); }
	 else{ }
  });
// for Task Assign  
  $('#a25').click(function(){
	 if($(this).is(':checked')){
		 $('#r25,#w25,#d25,#u25').prop('checked',true);
		 $('#n25').prop('checked',false);
	 }
	 else{ $('#r25,#w25,#d25,#u25').prop('checked',false); }
  });
  $('#r25,#w25,#d25,#u25').click(function(){
	 if($(this).is(':checked')){ $('#n25').prop('checked',false);}
	 else{ $('#a25,#n25').prop('checked',false); }
  });
  $('#n25').click(function(){
	 if($(this).is(':checked')){ $('#r25,#w25,#d25,#u25,#a25').prop('checked',false); }
	 else{ }
  });
// for Area Master
  $('#a26').click(function(){
	 if($(this).is(':checked')){
		 $('#r26,#w26,#d26,#u26').prop('checked',true);
		 $('#n26').prop('checked',false);
	 }
	 else{ $('#r26,#w26,#d26,#u26').prop('checked',false); }
  });
  $('#r26,#w26,#d26,#u26').click(function(){
	 if($(this).is(':checked')){ $('#n26').prop('checked',false);}
	 else{ $('#a26,#n26').prop('checked',false); }
  });
  $('#n26').click(function(){
